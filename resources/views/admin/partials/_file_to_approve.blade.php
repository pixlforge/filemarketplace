    ...
    @slot ('links')
        <div class="level">
            <div class="level-left">
                ...
                <form method="POST" action="{{ route('admin.files.new.update', $file) }}" id="approve-{{ $file->id }}" class="is-hidden">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                </form>
                ...
                <form method="POST" action="{{ route('admin.files.new.destroy', $file) }}" id="reject-{{ $file->id }}" class="is-hidden">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                </form>
            </div>
